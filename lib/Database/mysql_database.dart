...
import 'package:creativedesign/Database_Codes/mysql_database_code.dart';
...
class _MySQL_DatabaseState extends State<MySQL_Database> {
  ...
  _getStudent(){
    Services.getStudent().then((student){
      ...
      print("Length Of Data : ${_student.length}");
    });
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>MySQL_Database_Code()));
            },
      ...
      body: _student != null ? _dataBody() : Center(child: LoadingRotating.square(size: 40,borderSize: 2.5,borderColor: Colors.cyan,),) ,
    );
  }
}
